...
- `stl/_side_view.py` – **Seitenansicht-Kontrolle**: rendert orthografische Seitenansichten + Querschnitte (Y-/X-Mitte) einer STL als PNG (`*_side.png`), zur Selbstkontrolle der Skript-Ergebnisse ohne Slicer. Aufruf: `python other_media/stl/_side_view.py datei.stl [--ppm 8] [--zx 2]`.
